...
- **새 맥은 개인 계정 + username `ckyeon`.** 회사 계정(kyle@gigr.ai)의 claude.ai 대화·커넥터·구독은 반출 불가로 간주. llm-wiki의 매일 09:00 자동 유지보수 routine은 개인 계정 소유로 확인되어 퇴사와 무관하게 생존한다 (이 세션 계정의 routine 목록은 0개 — 교차 확인).
